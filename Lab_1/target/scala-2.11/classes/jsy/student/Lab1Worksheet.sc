...
def repeat(s: String, n: Int): String =  s.toString * n;
  //n match{
  //case zero if (n==0) =>""
  //case emptyString if (s=="") => throw new IllegalArgumentException("Error empty string")
  //case fail if (n<0) => throw new IllegalArgumentException("Error negative rep")

val test_string: String= repeat("a",3)
